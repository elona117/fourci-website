...
import { NavItem, Program, ImpactStat, Resource, TeamMember } from './types';
...
export const PROGRAMS: Program[] = [
  {
    ...
    description: 'Educating local communities and youths about the impacts of global warming and sustainable living.',
    image: 'https://images.unsplash.com/photo-1497435334941-8c899ee9e8e2?auto=format&fit=crop&q=80&w=800',
    icon: 'Megaphone',
  },
  {
    id: 'protection',
    title: 'Environmental Protection',
    description: 'Reforestation initiatives and conservation projects to restore biodiversity in fragile ecosystems.',
  ...
  },
  {
    ...
    description: 'Empowering vulnerable populations with adaptation strategies to handle climate-induced challenges.',
  ...
  },
  {
    ...
    description: 'Engaging with government stakeholders to push for better environmental laws and policies.',
...
export const IMPACT_STATS: ImpactStat[] = [
  ...
  { label: 'Youth Volunteers', value: '850', suffix: '+' },
  { label: 'Hectares Restored', value: '250', suffix: '' },
];

/**
 * Manage your Resources here just like the Team Members.
 * Add a new object to this array to show it on the /resources page.
 */
...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    id: 'exec-director',
    name: 'Gabriel Abraham Bala',
    role: 'Executive Director',
    bio: 'A visionary leader dedicated to environmental justice in Northern Nigeria, Gabriel steers FOURCi’s strategic partnerships and regional advocacy efforts.',
    image: 'https://i.postimg.cc/QM0k84km/FB-IMG-1768628834350.jpg',
    category: 'Leadership',
  ...
  },
  {
    ...
    bio: 'Amina oversees the seamless execution of our reforestation projects, managing logistics and field compliance across Borno and beyond.',
